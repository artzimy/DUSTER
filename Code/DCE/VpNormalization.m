...
montage(floor(mritransformNoSqueeze(IRGB3*256*10/3)),jet(256));
...
IRGB3=repmat(permute(Tmp(GoodRows,GoodCols,GoodSlices),[1 2 4 3]),[1 1 1 1]);
figure(1122);clf;
montage(floor(mritransformNoSqueeze(IRGB3*256)),jet(256));
...
IRGB3=repmat(permute(Tmp(GoodRows,GoodCols,GoodSlices),[1 2 4 3]),[1 1 1 1]);
figure(1122);clf;
montage(floor(mritransformNoSqueeze((IRGB3+1)*256/max(Tmp(:)))),jet(256));
title('BAT range [0 1]');
set(gcf,'Position',figposition([0 0 100 100]));
