...
function DCET1_CTCfN(DCEInfo, Additional_T1_Maps_Time_Stamps, WorkingP,DoN3,DoGlobal,DoDeviations,CalcForce,WhichMean,Options,RelaxFN,B1MapFN,B1MapFactor)
...
% RelaxFN=[WorkingP 'rT1map_brain.nii'];
...
if(~isempty(B1MapFN))
    B1M=loadniidata(B1MapFN);
    FA3D=FA3D.*B1M/B1MapFactor;
end
%%
